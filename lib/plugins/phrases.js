...
(function() {
  ...
  Phrases = (function() {
    ...
    Phrases.prototype.load_phrases = function() {
      this.phrases = [];
      this.static_phrases.forEach((function(_this) {
        return function(phrase) {
          return _this.phrases.push(phrase);
        };
      })(this));
      return Phrase.find({}, (function(_this) {
        return function(err, stored_phrases) {
    ...
    Phrases.prototype.save_phrase = function(phrase_record, message, room) {
      return phrase_record.save((function(_this) {
        return function(err, new_phrase) {
          return User.findOne({
    ...
    Phrases.prototype.add_phrase = function(regex, phrase, message, room) {
      ...
      return Phrase.findOne({
        ...
        return function(err, existing_phrase) {
    ...
    Phrases.prototype.match_phrase = function(message, room) {
      ...
      return this.phrases.forEach((function(_this) {
        return function(phrase) {
          var choose, match;
          if (phrase.precedent) {
