    ...
    http_listen: function(request, response, logger) {
      ...
      if (/\/commit/i.test(request.url)) {
        ...
        request.on('end', function() {
          var after, after_token, before, before_token, branch, commit, ex, hash_token, link_to_commit, payload, project, qty;
          ...
          try {
            ...
            branch = /\//.test(commit.ref) ? /\/([^/]*)$/.exec(commit.ref)[1] : commit.ref;
