...
(function() {
  var SpeakOnce, airbrake_room_id, curl, getClientIp, util, _, _ref;
    ...
    http_listen: function(request, response, logger) {
      ...
      if (/\/airbrake-webhook/i.test(request.url)) {
        ...
        return request.on('end', function() {
          var e, error, error_message, imcoming, incoming;
          ...
          try {
            ...
            return new SpeakOnce(airbrake_room_id, function(room) {
              if (data.length > 0) {
