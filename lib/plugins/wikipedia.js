...
(function() {
  var curl, deUnicode, qs, util, wikipedia_host, _, _un_un_re;
  ...
  deUnicode = function(string) {
    return string.replace(_un_un_re, '');
  };
    ...
    listen: function(message, room, logger) {
      ...
      if (/pat/i.test(body) && /look up:/i.test(body)) {
        ...
        return curl(options, function(data) {
          var content, out, page, results, _ref, _results;
          ...
          try {
            ...
            for (page in _ref) {
              ...
              _results.push(room.speak(deUnicode(content.extract), logger));
            }
            return _results;
          } catch (e) {
