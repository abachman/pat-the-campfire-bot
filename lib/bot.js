(function() {
  var Campfire, Counter, EventEmitter, NODE_ENV, User, bot, campfire_instance, debuglog, find_or_create_user, heartbeat, http, increment, logger, plugins, port, server, store, track_message, util, _;
  http = require('http');
  ...
  heartbeat = null;
  campfire_instance.room(process.env.campfire_bot_room, function(room) {
    var handle_message;
  ...
  server = http.createServer(function(req, res) {
    ...
    if (!plugins.http_notify(req, res, logger)) {
      res.writeHead(200, {
